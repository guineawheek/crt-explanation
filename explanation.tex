...
Not only do they have to be equal, both readings have to be zero, as well.
There's probably more rigor you can throw at this to prove that the encoder readings will act linearly past this second (0, 0) point that's an exercise for the overly pedantic reader.
